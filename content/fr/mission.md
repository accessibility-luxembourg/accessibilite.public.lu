...
- **l'audit approfondi de site** : il s'agit d'un audit de conformité basé sur le [référentiel RAWeb](../raweb1.1/index.html). Le résultat de l'audit permet de savoir si le site est accessible et quels sont les éventuels problèmes d'accessibilité rencontrés.
...
1. inventorier tous les sites et applications des organismes concernés par la loi. [L'inventaire des sites et apps publics](https://data.public.lu/fr/datasets/inventaire-des-sites-et-apps-du-secteur-public/) est disponible sur le portail Open Data.
