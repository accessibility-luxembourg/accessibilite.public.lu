...
* PAC (*PDF Accessibility Checker*{lang=en}) version 2024 pour Windows (<https://pac.pdf-accessibility.org/en/download>) : logiciel qui permet de contrôler certains points d'accessibilité des documents PDF ;
