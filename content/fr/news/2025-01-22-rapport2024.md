...
<figure class="chart">
    ...
    <details>
        ...
        <p>This column chart shows the average compliance scores of state, municipal and other public entity sites over two campaigns (2020-2021 and 2022-2024).</p>
    </details>
</figure>
...
<aside class="more">
    ...
    <ul>
        <li><a href="https://data.public.lu/fr/">Le rapport 2022 – 2024</a></li>
