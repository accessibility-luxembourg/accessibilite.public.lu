...
---
<script src="../../fr/news/2025-01-15-rapport2024.js" type="module"></script>
<hgroup>
...
<figure role="group" aria-label="Photo: Getty Images / istockphoto.com / SilviaJansen" class="pic">
    <img src="img/2024-report/2024-report.jpg" alt="Image d'illustration représentant une personne aveugle consultant des informations sur son téléphone, à un arrêt de bus">
...
<figure class="chart">
    <div id="full_compliance">
        <img src="img/2024-report/2024_full_compliance.svg" alt="Graphique 1. Taux de conformité des sites audités en 2024 (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="admin_levels">
        <img src="img/2024-report/2024_admin_levels.svg" alt="Graphique 2. Contrôle simplifié des sites Web, scores moyens de conformité par niveau administratif, comparaison des campagnes 2020 – 2021 et 2022 – 2024 (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="complaints">
        <img src="img/2024-report/2024_complaints.svg" alt="Graphique 3. Nombre de réclamations par thème, de 2022 à 2024 (voir description ci-dessous).">
    </div>
    <details>
