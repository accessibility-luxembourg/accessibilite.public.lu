...
<script type="module" src="../../fr/news/2023-02-20-rapport2022.js"></script>
<hgroup>
...
<figure role="group" aria-label="Photo: iStock / Getty Images / carloscastilla" class="pic">
    <img src="img/2022-report/iStock1.jpg" alt="Image d'illustration représentant un logo d'une personne en fauteuil roulant sur un fond abstrait">
...
<figure class="chart">
    <div id="full_compliance">
        <img src="img/2022-report/full_compliance.svg" alt="Graphique 1. Niveau de conformité des sites audités en 2022, en pourcentage (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="full_themes">
        <img src="img/2022-report/full_themes.svg" alt="Graphique 2. Répartition des non-conformités, en pourcentage (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="simple_themes">
        <img src="img/2022-report/simple_themes.svg" alt="Graphique 3. Répartition des non-conformités, en pourcentage (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="simple_compliance">
        <img src="img/2022-report/simple_compliance.svg" alt="Graphique 4. Niveau de conformité, par domaine administratif, en pourcentage (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="full_app_compliance">
        <img src="img/2022-report/full_app_compliance.svg" alt="Graphique 5. Niveau de conformité des apps auditées en 2022, en pourcentage (voir description ci-dessous).">
    </div>
    <details>
...
<figure class="chart">
    <div id="full_app_themes">
        <img src="img/2022-report/full_app_themes.svg" alt="Graphique 6. Répartition des non-conformités sur les apps, en pourcentage (voir description ci-dessous).">
    </div>
    <details>
