...
steps:
  - Le message d’erreur fournissant une instruction ou une [indication du type de données et/ou de format](#indication-du-type-de-donnees-et/ou-de-format) obligatoire est visible et identifie le champ concerné.
