...
steps:
  - Une instruction ou une [indication du type de données et/ou de format](#indication-du-type-de-donnees-et/ou-de-format) obligatoire est visible et située dans la balise `<label>` associée au champ.
  - Une instruction ou une [indication du type de données et/ou de format](#indication-du-type-de-donnees-et/ou-de-format) obligatoire est visible et située dans le [passage de texte](#passage-de-texte-lie-par-aria-labelledby-ou-aria-describedby) associé au champ.
---
