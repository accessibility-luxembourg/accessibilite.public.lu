---
title: Chaque contenu additionnel qui apparaît au survol d’un [composant d’interface](#composant-d-interface) peut-il être survolé par le pointeur de la souris sans disparaître (hors cas particuliers) ?
---

1. Retrouver dans le document les contenus additionnels devenant visibles au survol d’un composant d’interface, à l’exception :
