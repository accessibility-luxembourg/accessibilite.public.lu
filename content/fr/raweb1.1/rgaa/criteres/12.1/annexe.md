...
Note : l’appréciation d’un nombre très limité de pages devrait être réservée à un site dont l’ensemble des pages sont atteignables depuis la page d’accueil.
