---
title: Dans chaque page web, chaque [contenu cryptique](#contenu-cryptique) de décoration est-il correctement ignoré par les technologies d’assistance au moyen d’un attribut WAI-ARIA `aria-hidden="true"` ?
---

1. Retrouver dans le document les contenus cryptiques décoratifs.
