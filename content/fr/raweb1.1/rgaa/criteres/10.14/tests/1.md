...
1. Retrouver dans le document les contenus additionnels devenant visibles au survol d’un composant d’interface au moyen d’un mécanisme CSS (`pseudo-classe :hover`).
