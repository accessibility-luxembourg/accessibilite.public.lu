...
1. Retrouver dans le document les contenus additionnels devenant visibles à la prise de focus d’un composant d’interface au moyen d’un mécanisme CSS (`pseudo-classe :focus`).
