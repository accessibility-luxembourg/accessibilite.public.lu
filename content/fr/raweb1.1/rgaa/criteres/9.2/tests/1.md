---
title: Dans chaque page web, les zones principales de la page constituant la [structure du document](#structure-du-document) vérifient-elles ces conditions ?
steps:
  - L’élément contenant la [zone d’en-tête de la page](#zone-d-en-tete) a un [rôle calculé](#role-calcule) de `banner`.
  - Les éléments contenant les [zones de navigation principales et secondaires](#menu-et-barre-de-navigation) ont un [rôle calculé](#role-calcule) de `navigation`.
