...
steps:
  ...
  - La [structure du document](#structure-du-document) utilise un seul élément visible avec le [rôle calculé](#role-calcule) de `banner`.
  - La [structure du document](#structure-du-document) utilise un seul élément visible avec le [rôle calculé](#role-calcule) de `contentinfo`.
