...
Les rôles doivent être définis dans le document en fonction de la nature de la zone (grâce à l’attribut WAI-ARIA `role` ou une balise HTML ayant un rôle implicite, voir la notion de [rôle calculé](#role-calcule) à ce sujet). WAI-ARIA désigne 8 landmarks. 
