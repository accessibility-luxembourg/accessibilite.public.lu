---
title: In each web page, do texts and image texts without bold effect with a rendered size greater than or equal to 24px meet one of these conditions (excluding special cases)?
steps:
...
1. Find in the document texts and image texts without bold effect with a rendered size greater than or equal to 24px that could cause contrast problems.
