---
title: For each vector image (`<svg>` tag) used as [CAPTCHA](#captcha) or as a [test image](#image-test), with a [text alternative](#textual-alternative-image), is this alternative relevant?
steps:
