...
1. Find in the document the images that are structured using an `<img>` element (or an element with the WAI-ARIA `role="img"` attribute) and conveying information that requires a detailed description.
