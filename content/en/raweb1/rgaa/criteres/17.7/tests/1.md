---
title: For each [real-time-text-communication](#real-time-text-communication-rtt) web application, the transmission time for each [input unit](#input-unit) is 500ms or less. Is this rule respected?
---
