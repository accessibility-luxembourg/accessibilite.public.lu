...
[Examples (zip file, 9.24 MB, in French)](/fr/files/ressources-rapdf1.zip) are available to illustrate the testing methodology. Each criterion is illustrated by a screen shot taken from the PAC tool.
