...
2. Check that the element can be accessed using the keyboard:
   ...
   - If the element manages a simple action, it can be activated using the keyboard with the default key(s) in the user agents (e.g. <kbd>Enter</kbd>, <kbd>Space</kbd>).
