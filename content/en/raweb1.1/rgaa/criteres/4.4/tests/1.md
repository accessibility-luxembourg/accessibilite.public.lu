...
1. Find the pre-recorded synchronised time-based media with synchronised captions in the document.
2. For each pre-recorded synchronised time-based media, check that the captions are:
