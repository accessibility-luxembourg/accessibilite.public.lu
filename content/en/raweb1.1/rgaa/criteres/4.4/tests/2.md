---
title: For each live synchronised [time-based media](#time-based-media-audio-video-and-synchronised) with synchronised [captions](#synchronised-captions-media-object), does at least one caption track meet these conditions?
steps:
...
1. Find the live synchronised time-based media with synchronised captions in the document.
2. For each live synchronised time-based media, check that the captions are:
