...
steps:
  ...
  - Elements that have a [computed role](#computed-role) of `navigation` are reserved for structuring [primary and secondary navigation regions](#menu-and-navigation-bar).
---
