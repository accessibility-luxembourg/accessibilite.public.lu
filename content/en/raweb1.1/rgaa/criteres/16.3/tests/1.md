...
2. For each item of documentation, check 
	- if it is a web page (HTML, CSS), that it complies with the [RAWeb](../raweb1.1/criteres.html);
	- if it is an office document in PDF format, that it complies with the [PDF accessibility assessment framework (RAPDF)](../rapdf1.1/index.html);
