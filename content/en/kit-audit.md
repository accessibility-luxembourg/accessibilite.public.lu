...
## Website audit
* [Website audit report template](../raweb1.1/files/raweb1-1-lu-modele-rapport-audit.docx), Docx format (68 kb)
* [Website audit grid template](../raweb1.1/files/raweb1-1-lu-modele-grille-audit.xlsx), Xlsx format (374 kb)
* [Instructions for carrying out the audit of a website](../raweb1.1/methodo-test.html#assessment-of-compliance-with-the-reference-standard), sampling of pages, applicable criteria, compliance rate, etc.
