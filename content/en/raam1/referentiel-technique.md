...
#### [Criterion 1.3](#crit-1-3) [A] For each [graphic element conveying information](glossaire.md#information-carrying-graphic-element), the alternative [accessible to assistive technologies](glossaire.md#accessible-to-assistive-technologies) relevant (except in particular cases)? {id="crit-1-3"}
...
#### [Criterion 1.6](#crit-1-6) [A] Does each [graphic element conveying information](glossaire.md#information-carrying-graphic-element) have, if necessary, a [detailed description](glossaire.md#description-detaillee)? {id="crit-1-6"}
...
#### [Criterion 1.7](#crit-1-7) [A] For each [graphic element conveying information](glossaire.md#information-carrying-graphic-element) having a [detailed description] (glossaire.md#detail-description), is this relevant? {id="crit-1-7"}
...
#### [Criterion 3.12](#crit-3-12) [A] Is each automatically triggered sound sequence [controllable](glossaire.md#control-sound-triggered-automatically) by the user? {id="crit-3-12"}
...
#### [Criterion 10.1](#crit-10-1) [A] In each screen, is the [tab order](glossaire.md#tab-order) on the keyboard [consistent]( glossaire.md#coherent-order-of-reading)? {id="crit-10-1"}
...
#### [Criterion 10.2](#crit-10-2) [A] In each screen, is the order of restitution by the assistive technologies [consistent](glossaire.md#coherent-order-of -reading)? {id="crit-10-2"}
...
#### [Criterion 10.4](#crit-10-4) [A] In each screen, the [keyboard shortcuts](glossaire.md#keyboard-shortcut) using only one key (lowercase or uppercase letter , punctuation, number or symbol) are they controllable by the user? {id="crit-10-4"}
...
#### [Criterion 11.7](#crit-11-7) [A] In each screen, [abrupt changes in brightness or flash effects](glossaire.md#abrupt-change-of-brightness-or- (flash-effect) are they used correctly? {id="crit-11-7"}
...
#### [Criterion 11.8](#crit-11-8) [A] In each screen, is each moving or flashing content [controllable](glossaire.md#control-content-in-movement-or- flashing) by the user? {id="crit-11-8"}
...
#### [Criterion 11.15](#crit-11-15) [A] Each identification or control functionality of the application that relies on the use of [biological characteristic](glossaire.md#biological-characteristic ) of the user, does it have an alternative method? {id="crit-11-15"}
...
#### [Criterion 13.1](#crit-13-1) [A] Does the [editing tool](glossaire.md#edition-tool) allow you to define the [accessibility information] (glossaire.md#accessibility-information) necessary to create compliant content? {id="crit-13-1"}
...
#### [Criterion 13.6](#crit-13-6) [A] Is each [template](glossaire.md#template) that meets the RAWeb requirements clearly identifiable? {id="crit-13-6"}
...
#### [Criterion 14.1](#crit-14-1) [AA] Does each [helpdesk](glossaire.md#helpdesk) provide information related to [accessibility features] (glossaire.md#accessibility-feature) of the application described in the documentation? {id="crit-14-1"}
...
#### [Criterion 15.2](#crit-15-2) [A] Does each application that allows [bidirectional oral communication](glossaire.md#bidirectional-oral-communication-application) have 'a functionality of [written communication in real time](glossaire.md#communication-written-in-real-time)? {id="crit-15-2"}
...
#### [Criterion 15.3](#crit-15-3) [A] For each application that allows [bidirectional oral communication](glossaire.md#bidirectional-oral-communication-application) and [written in time real](glossaire.md#communication-written-in-real-time), can the two modes be used simultaneously? {id="crit-15-3"}
...
#### [Criterion 15.5](#crit-15-5) [A] For each application of [two-way oral communication](glossaire.md#application-of-oral-two-way-communication), a visual indicator of the oral activity present? {id="crit-15-5"}
...
#### [Criterion 15.6](#crit-15-6) [A] Each [real-time written communication](glossaire.md#real-time-written-communication) application that can interact with Do other [real-time written communication](glossaire.md#real-time-written-communication) applications comply with the interoperability rules in force? {id="crit-15-6"}
...
#### [Criterion 15.9](#crit-15-9) [A] For each [bidirectional oral communication](glossaire.md#bidirectional-oral-communication-application) application that provides identification of the Questioner, is there a way to present this identification for sign language users? {id="crit-15-9"}
...
#### [Criterion 15.10](#crit-15-10) [A] For each [two-way oral communication] application (glossaire.md#two-way-oral-communication-application) that has [voice functionalities] (glossaire.md#voice-functionalities), can these be used without the need to listen or speak? {id="crit-15-10"}
...
#### [Criterion 15.11](#crit-15-11) [AA] For each [bidirectional oral communication](glossaire.md#bidirectional-oral-communication-application) application that has live video real time, is the video quality sufficient? {id="crit-15-11"}
...
- The video resolution meets the [QVGA](glossaire.md#qvga) standard at least;
