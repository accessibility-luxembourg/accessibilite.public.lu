**Warning:** RAAM is based on the European standard EN 301 549, version 3.2.1, the only legally binding document, and this framework incorporates the criteria associated with evaluating mobile apps. For each criterion in the framework, an evaluation methodology is proposed. This methodology is provided as a starting point for using the framework, giving an example of a possible evaluation method, but others may exist. Furthermore, this methodology cannot replace training, particularly in the use of evaluation tools (such as screen readers) or in understanding the challenges of digital accessibility on mobile platforms. The methodology also requires time to get started before an effective and comprehensive audit can be carried out, and it does not exempt users from carefully reading the criteria themselves. Finally, it is possible that errors may not be detected based solely on this methodology.
...
- **[Test 12.4.1](#test-12-4-1):** Does the [documentation](glossaire.md#documentation) made available in web format (HTML, CSS) comply with the [RAWeb](../raweb1.1/criteres.html)? {id="test-12-4-1"}
...
1. For a documentation in web format (HTML, CSS), check that it complies with the [RAWeb](../raweb1.1/criteres.html) criteria.
...
- **[Test 13.1.1](#test-13-1-1):** Can each [editing tool](glossaire.md#editing-tool) that creates content in web format (HTML, CSS) be used to define the [accessibility information](glossaire.md#accessibility-information) needed to create content that complies with the [RAWeb](../raweb1.1/index.html)? {id="test-13-1-1"}
...
1. For functions that allow content to be created in web format (HTML, CSS), check that it is possible to define the accessibility information needed to make the content compliant with the [RAWeb](../raweb1.1/index.html). For example:
...
1. For each piece of content in web format (HTML, CSS), check that:
	- the information necessary for it to comply with the [RAWeb](../raweb1.1/index.html) (e.g. the alternative of an image, the headings levels) is preserved in the generated content;
...
- **[Test 13.5.1](#test-13-5-1):** For each set of [templates](glossaire.md#template) in web format (HTML, CSS), at least one template complies with the [RAWeb](../raweb1.1/index.html). Is this rule respected? {id="test-13-5-1"}
...
1. For templates in web format (HTML, CSS), check that at least one template meets all the [RAWeb](../raweb1.1/index.html) criteria.
...
- **[Test 14.3.1](#test-14-3-1):** Does the [documentation](glossaire.md#documentation) provided by the support service in web format (HTML, CSS) comply with the [RAWeb](../raweb1.1/index.html)? {id="test-14-3-1"}
...
1. For documentation in web format (HTML, CSS), check that it complies with the [RAWeb](../raweb1.1/criteres.html) criteria.
