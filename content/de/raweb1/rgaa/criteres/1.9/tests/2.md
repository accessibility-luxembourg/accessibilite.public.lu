---
title: Does each [object image](#image-objet) with a [legend](#image-caption) (tag `<object>` with the attribute `type="image/..."` associated with an adjacent [legend](#image-caption), if necessary, meet these conditions?
steps:
