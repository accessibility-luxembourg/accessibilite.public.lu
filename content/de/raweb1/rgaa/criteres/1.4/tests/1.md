---
title: For each image (tag `<img>`) used as [CAPTCHA](#captcha) or as [test image](#image-test), having a [text alternative](#alternative-text-image), is this alternative relevant?
steps:
