---
title: For each [object image](#image-objet) (tag `<object>` with the attribute `type="image/..."`) used as a [CAPTCHA](#captcha) or as a [test image](#image-test), having a [text alternative](#alternative-text-image) or an [alternative content](#alternative-content), is this alternative relevant?
steps:
