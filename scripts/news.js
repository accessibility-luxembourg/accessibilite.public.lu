...
function genNews(config, lang, outputPath, baseURL, __) {
    ...
    articles.forEach((e, i, ar) => {
        lib.genFile(config, './src/tpl/article.ejs', {data: e.html, meta: e.meta, previous: ar[i+1], next: ar[i-1]}, e.meta.title, lang, outputPath+'/'+lang+'/news/'+e.meta.filename+'.html', e.meta.filename, '../..', __, false, '', true, e.meta.subtitle, e.meta.imgTwitter, e.meta.imgLinkedin, true)
    })
    return articles
}
